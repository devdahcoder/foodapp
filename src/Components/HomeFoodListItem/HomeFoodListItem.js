...
import "./homefoodlistitem.css";



const HomeFoodListItem = ({dish}) => {
    return (
        <div className="main-food-order-list-li-container">
            <li className="main-food-order-list-li">
                <div className="main-food-order-list-item">
                    <div className="main-food-order-list-qty-price-display">
                        ...
                        <div className="main-food-order-list-detail-container">
                            <div className="main-food-order-list-detail">
                                ...
                                <div className="main-food-order-list-detail-name-container">
                                    <div className="main-food-order-list-detail-order-name-display">
                                        <p>{dish.name}</p>
                                    </div>
                                    <div className="main-food-order-list-detail-padding">

                                    </div>
                                    <div className="main-food-order-list-price-number">
                                        <p>
                                            {dish.price}
                                        </p>
                                    </div>
                            ...
                            <div className="main-food-order-list-qty">
                                <p>2</p>
                            </div>
                        </div>
                    ...
                    <div className="main-food-order-middle-padding">
                    ...
                    <div className="main-food-order-list-order-note-btn-display">
                        <div className="main-food-order-list-order-note-container">
                            <div className="main-food-order-list-order-input-note-display">
                                <input type="text" name="" id="" placeholder="Order Note..." />
                            </div>
                        </div>
...
export default HomeFoodListItem
